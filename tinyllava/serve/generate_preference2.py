...
def main(args):
    ...
    for l, sample in enumerate(images_list[25000:50000]):
        print(l+25000)
    ...
    with open("/home/httang/project/llava/TinyLLaVA_Factory-main/generate/preference/generated_report_Medical-Llama3-8B-XrayCLIP__vit-b-16__laion2b-s34b-b88k-base-mimic-finetune-vit-frozen-llm-2.json", 'w', encoding='utf-8') as f:
