...
def main(args):
    ...
    for l, sample in enumerate(images_list[10000:]):
        print(l+10000)
    ...
    with open("/home/httang/project/llava/TinyLLaVA_Factory-main/generate/greedy_decoding/generated_report_Meta-Llama-3-8B-Instruct-siglip-base-patch16-224-base-mimic-finetune-vit-llm-no-RAG-3.json", 'w', encoding='utf-8') as f:
