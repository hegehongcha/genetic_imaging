...
def main(args):
    ...
    with open("/home/httang/project/llava/TinyLLaVA_Factory-main/mimic/test_samples.json", "r") as f:
        samples = json.load(f)
    ...
    for l, sample in enumerate(images_list[5000:10000]):
        print(l+5000)
    ...
    with open("/home/httang/project/llava/TinyLLaVA_Factory-main/generate/greedy_decoding/generated_report_Meta-Llama-3-8B-Instruct-siglip-base-patch16-224-base-mimic-finetune-vit-llm-no-RAG-2.json", 'w', encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    args = parser.parse_args(args=["--model-path", "/home/httang/project/llava/TinyLLaVA_Factory-main/checkpoints/llava_factory/tiny-llava-Meta-Llama-3-8B-Instruct-siglip-base-patch16-224-base-mimic-finetune-vit-llm"])
    main(args)
