...
class LlamaTemplate(Template):
    ...
    format_assistant: "Formatter" = StringFormatter(slot="ASSISTANT" + ": Let us solve it step by step." + "</s>")
    system: "Formatter" = EmptyFormatter(slot=system+" ")
    separator: "Formatter" = EmptyFormatter(slot=[' ASSISTANT: Let us solve it step by step.', '</s>'])
