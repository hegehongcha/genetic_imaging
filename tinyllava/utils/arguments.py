...
from typing import Dict, Optional, Sequence, TYPE_CHECKING, Any, Literal
import transformers
from enum import Enum
from trl.trainer import DPOConfig, GRPOConfig
if TYPE_CHECKING:
    import transformers
...
class DataArguments:
    ...
    evaluation_data_path: str = field(default=None,
...
@dataclass
class GRPOTrainingArguments(TrainingArguments, GRPOConfig):
    training_recipe: str = field(default='common')
    tune_type_llm: str = field(default="frozen")  # support only: frozen, full, lora, qlora_int4, qlora_int8
    tune_type_vision_tower: str = field(default="frozen")  # support only: frozen, full, partially-tune
    tune_vision_tower_from_layer: Optional[int] = field(default=10)
    ...
    model_max_len: Optional[int] = field(
        default=2048,
