...
from tinyllava.train.tinyllava_trainer import LLaVADPOTrainer
from tinyllava.training_recipe import TrainingRecipeFactory
from tinyllava.utils import *
from tinyllava.model import *
from tinyllava.data.dataset import make_dpo_data_module
# from tinyllava.trl.trainer import DPOConfig
...
def train():
    ...
    if use_dpo:
        model, _, _, _ = load_pretrained_model(model_name_or_path="/home/httang/project/llava/TinyLLaVA_Factory-main/checkpoints/llava_factory/tiny-llava-Qwen2.5-7B-clip-vit-base-patch16-base-mimic-finetune-vit-frozen-llm")
    else:
    ...
    trainer = LLaVADPOTrainer(model=model,  # does not require model.to(device), huggingface/deepspeed does it for you?
                           tokenizer=tokenizer,
