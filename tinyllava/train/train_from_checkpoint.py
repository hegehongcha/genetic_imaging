...
def train():
    ...
    trainer.train(resume_from_checkpoint="/home/httang/project/llava/TinyLLaVA_Factory-main/checkpoints/llava_factory/tiny-llava-Medical-Llama3-8B-XrayCLIP__vit-b-16__laion2b-s34b-b88k-base-mimic-finetune-vit-frozen-llm/checkpoint-14059")
